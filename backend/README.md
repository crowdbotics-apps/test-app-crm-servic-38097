...
## Project Structure
    ...
    ├── test_app_crm_servic_38097  # Django project configurations
...
1. Clone this repo and `cd test_app_crm_servic_38097`
...
2. Clone this repo and `cd test_app_crm_servic_38097`
